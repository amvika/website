...
import FranchiseHero from './Section/FranchiseHero';
import DiscouteScroll from './Section/DiscouteScroll';
...
const OurFranchise = () => {
  ...
  const talentConnectorDetails = {
    ...
    description: "Identify individuals in your network and introduce them to the brain analysis service, which provides an 'Individual Brain Report' through eye analysis.",
    benefits: [
  ...
  const businessOwnerDetails = {
    ...
    description: "Launch your own business offering services like GST registration, tax consultation, audit support, accounting, and the brain report service.",
    benefits: [
  ...
  return (
    ...
    <div className='mt-28'>
      ...
      <div className="py-16 px-6 md:px-20 bg-white">
        ...
        >
          <h2 className="text-4xl font-bold mb-4 text-black">Our Franchise <span className="text-[#066d73]">Models</span></h2>
        ...
        <motion.div
          className="mb-16 bg-white p-8 rounded-lg shadow-sm border border-gray-100"
        ...
        >
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="mb-6">
                <p className="text-gray-600">{talentConnectorDetails.description}</p>
              </div>
              
              <div className="mb-6">
                <h4 className="font-semibold text-lg mb-2 text-gray-800">Opportunity:</h4>
                <p className="text-gray-600">Help others understand their unique capabilities and guide them towards fulfilling career paths.</p>
              </div>
              
              <div className="mb-6">
                <h4 className="font-semibold text-lg mb-2 text-gray-800">Earning Potential:</h4>
                <p className="text-gray-600">Unlimited; dedicating as little as 1 hour per day can potentially yield significant earnings.</p>
              </div>
            </div>
        ...
        >
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="mb-6">
                <p className="text-gray-600">{businessOwnerDetails.description}</p>
              </div>
              
              <div className="mb-6">
                <h4 className="font-semibold text-lg mb-2 text-gray-800">Opportunity:</h4>
                <p className="text-gray-600">Even without prior expertise, a comprehensive 1-hour training equips you to offer these services effectively from home.</p>
              </div>
              
              <div className="mb-6">
                <h4 className="font-semibold text-lg mb-2 text-gray-800">Earning Potential:</h4>
                <p className="text-gray-600">Substantial income with the potential to earn up to ₹3 Lakhs per month.</p>
              </div>
            </div>
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Join Amvika NEXT's mission to uncover potential and shape futures—while building your own successful business or career.
          </p>
          <motion.button 
